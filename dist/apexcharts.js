  ...
  function () {
    ...
    _createClass(XAxis, [{
      ...
      value: function drawXaxis() {
        ...
        var ticks = w.config.xaxis.ticks || [];
        var labelsLen = labels.length;

        if (w.config.xaxis.labels.show) {
          var _loop = function _loop(_i) {
            var x = 0; // xPos - colWidth / 2 + w.config.xaxis.labels.offsetX

            if (ticks.length) {
              var xValue = ticks[_i];
              var min = w.globals.minX;
              var range = w.globals.xRange;
  ...
  function () {
    ...
    _createClass(Grid, [{
      ...
      value: function _drawXYLines(_ref4) {
        ...
        var manualCategoryLines = function manualCategoryLines(_ref6) {
        ...
        var categoryLines = function categoryLines(_ref7) {
          var xC = _ref7.xC,
              x1 = _ref7.x1,
              y1 = _ref7.y1,
              x2 = _ref7.x2,
      ...
      value: function _drawInvertedXYLines(_ref8) {
        var xCount = _ref8.xCount;
